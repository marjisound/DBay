...
class NotifyWatchEnd{
    ...
    public function show(){
        ...
        <h3>Auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a> ended</h3>
        <p>The auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		ended on $endDate.</p>";
		if ($hiBid == -0.01){
...
class NotifyWatchCont{
    ...
    public function show(){
		...
		$hiBid = $this->hiBid;
        echo "<div class=\"alert alert-info\">
        <h3>Auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a> ongoing</h3>";
        if ($hiBid==-0.01){
            echo "<p>There are currently no bids
			for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>.</p>";
        } else{
            echo "<p>The highest bid for <a href=\"auction.php?a_id=$auctionID\">
...
class NotifyWon{
    ...
    public function show(){
        ...
        <h3>Won auction
		for <a href=\"auction.php?a_id=$auctionID\">$itemName</a></h3>
...
class NotifyTooLow{
    ...
    public function show(){
        ...
        <h3>Bid for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		too low</h3>
		<p>The auction
		for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		ended on $endDate.
...
class NotifyLost{
    ...
    public function show(){
        ...
        $hiBid = $this->hiBid;
        echo "<div class=\"alert alert-danger\">
        <h3>Lost auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a></h3>";
...
class NotifySold{
    ...
    public function show(){
        ...
        echo "<div class=\"alert alert-success\">
        <h3><a href=\"auction.php?a_id=$auctionID\">$itemName</a> sold</h3>
		<p>You sold <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		for &pound;$hiBid</p>
...
class NotifyTooHigh{
    ...
    public function show(){
		...
		$hiBid = $this->hiBid;
        echo "<div class=\"alert alert-danger\">
        <h3>All bids for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		below reserve</h3>
		<p>The auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
...
class NotifyNoBidEver{
    ...
    public function show(){
		...
		$viewCount = $this->viewCount;
        echo "<div class=\"alert alert-danger\">
        <h3>No bids for <a href=\"auction.php?a_id=$auctionID\">$itemName</a></h3>
		<p>The auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
...
class NotifySelling{
    ...
    public function show(){
		...
		$hiBid = $this->hiBid;
        echo "<div class=\"alert alert-success\">
        <h3>Auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		ongoing</h3>
		<p>The auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
...
class NotifyNoBidYet{
    ...
    public function show(){
		...
		$viewCount = $this->viewCount;
        echo "<div class=\"alert alert-warning\">
        <h3>No bids for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
		yet</h3>
		<p>The auction for <a href=\"auction.php?a_id=$auctionID\">$itemName</a>
